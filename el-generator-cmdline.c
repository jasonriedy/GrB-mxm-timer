...
const char *gengetopt_args_info_usage = "Usage: el-generator [OPTION]...";

const char *gengetopt_args_info_versiontext = "Copyright 2022, Lucata Corporation";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->tree_help = gengetopt_args_info_help[7] ;
  args_info->filename_help = gengetopt_args_info_help[9] ;
  args_info->binary_help = gengetopt_args_info_help[10] ;
  args_info->neo4j_help = gengetopt_args_info_help[11] ;
  args_info->NE_chunk_size_help = gengetopt_args_info_help[13] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->neo4j_given)
    write_into_file(outfile, "neo4j", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVs:e:A:B:N:Tf:b", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'N':	/* Noise factor on each recursion.  */
          ...
          break;
        case 'T':	/* Generate a random spanning tree to join all components.  */
          ...
          break;
        case 'f':	/* Filename for the edge list, - for stdout.  */
          ...
          break;
        case 'b':	/* File is in binary format.  */
        ...
        case 0:	/* Long option with no short option */
          /* Output the CSV Neo4J expects.  */
          if (strcmp (long_options[option_index].name, "neo4j") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->neo4j_flag), 0, &(args_info->neo4j_given),
                &(local_args_info.neo4j_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "neo4j", '-',
                additional_error))
              goto failure;
